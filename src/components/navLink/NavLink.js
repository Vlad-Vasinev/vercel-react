...
const NavLink = () => {
    ...
    const pinkColor = useSelector(state => state.theme.btnBackBG);

    return (
        <div className={classes.linkInner}>
            <Link className={classes.navLink} to="/" style = { { background: pinkColor } }>
            ...
            <div className={classes.linkInfo} > voting </div>
        </div>
    )
}
